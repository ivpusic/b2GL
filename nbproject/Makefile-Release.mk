...
${OBJECTDIR}/src/b2GL/globals.o: src/b2GL/globals.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/b2GL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/b2GL/globals.o src/b2GL/globals.cpp
...
${OBJECTDIR}/src/coreGL/GLSpriteTexture2D.o: src/coreGL/GLSpriteTexture2D.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/coreGL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/coreGL/GLSpriteTexture2D.o src/coreGL/GLSpriteTexture2D.cpp
...
${OBJECTDIR}/src/userGL/GLBullet.o: src/userGL/GLBullet.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/userGL/GLBullet.o src/userGL/GLBullet.cpp
...
${OBJECTDIR}/src/userGL/GLO.o: src/userGL/GLO.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/userGL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/userGL/GLO.o src/userGL/GLO.cpp

${OBJECTDIR}/src/userGL/GLTrack.o: src/userGL/GLTrack.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/userGL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/userGL/GLTrack.o src/userGL/GLTrack.cpp
